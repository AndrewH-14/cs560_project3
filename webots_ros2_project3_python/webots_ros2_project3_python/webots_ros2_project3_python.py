...
FORWARD_DETECT_RANGE               = 0.5
LEFT_DETECT_RANGE                  = 0.0
RIGHT_DETECT_RANGE                 = 0.5
...
NORMAL_TURNING_RIGHT_ANGULAR_SPEED = -0.3
...
class WallFollower(Node):
    ...
    def get_state(self):
        ...
        min_front_lidar_data = min(front_lidar_data[50:])
    ...
    def wall_detected(self, front_lidar_data):
        '''
        ...
        max_front_lidar_data  = max(front_lidar_data[35:55])

        self.get_logger().info(str(max_front_lidar_data))
    ...
    def wall_finder_mode(self):
        ...
        # handle if the start position is too close to a wall
        ...
        # again
        elif self.wall_detected(front_lidar_data):
